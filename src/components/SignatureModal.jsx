  ...
  return (
    ...
    >
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg p-5">
        ...
        <div
          className="border-2 border-dashed border-gray-300 rounded-lg bg-gray-50 mb-2"
        ...
        <div className="flex items-center justify-between mb-4">
          <button onClick={clearPad} className="text-xs text-gray-500 hover:text-gray-800">
            Clear
          </button>
          <p className="text-[11px] text-gray-400 italic">
            By signing you confirm approval of this change order.
          </p>
        </div>
