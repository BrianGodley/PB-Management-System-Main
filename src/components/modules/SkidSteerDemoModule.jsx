...
function calcDemo(
  ...
  const dumpGreen = n(mp['Demo - Skid Dump - Green Waste'])
  ...
  const containerPrice = n(mp['Demo - Skid Container (Low-Boy)'])
  const containerCy = n(mp['Demo - Skid Container Capacity (CY)'])
  const swellFactor = n(mp['Demo - Skid Removal Swell'])
  ...
  const baseMatPer10Cy = n(mp['Demo - Skid Import Base $/10cy'])
  ...
  const skidDemoRateList = [
      ...
      items: [
        {
          label: 'Dump - Concrete',
          table: 'misc_rates',
          name: 'Demo - Skid Dump - Concrete',
          category: 'Demo',
          mode: 'currency',
          unitLabel: 'Tons',
          value: n(materialPrices['Demo - Skid Dump - Concrete']),
        },
        {
          label: 'Dump - Dirt',
          table: 'misc_rates',
          name: 'Demo - Skid Dump - Dirt',
          category: 'Demo',
          mode: 'currency',
          unitLabel: 'Tons',
          value: n(materialPrices['Demo - Skid Dump - Dirt']),
        },
        {
          label: 'Dump - Green Waste',
          table: 'misc_rates',
        ...
        {
          label: 'Container (Low-Boy)',
          table: 'misc_rates',
          name: 'Demo - Skid Container (Low-Boy)',
          category: 'Demo',
          mode: 'currency',
          unitLabel: 'container',
          value: n(materialPrices['Demo - Skid Container (Low-Boy)']),
        },
        {
          ...
          mode: 'coefficient',
          unitLabel: 'Cu Yd',
          value: n(materialPrices['Demo - Skid Container Capacity (CY)']),
        },
        {
          label: 'Removal Swell',
          table: 'misc_rates',
          ...
          mode: 'coefficient',
          unitLabel: '×',
          value: n(materialPrices['Demo - Skid Removal Swell']),
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          category: 'Demo',
          mode: 'coefficient',
          unitLabel: 'hr per 100 Sq Ft per in deep',
    ...
    },
    {
      ...
      items: [
        ...
        {
          label: 'Import Base Material',
          table: 'misc_rates',
          name: 'Demo - Skid Import Base $/10cy',
          category: 'Demo',
          mode: 'currency',
          unitLabel: '10 Cu Yd',
          value: n(materialPrices['Demo - Skid Import Base $/10cy']),
        },
      ],
    },
    {
