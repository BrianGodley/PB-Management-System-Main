...
function calcDemo(state, laborRatePerHour, materialPrices, laborRates, subMarkupRate = 0.35, subRates = {}, gpmd = 425, walkAccess = null) {
  ...
  const totalDemoTons = isSub ? 0 : (
    conc.tons + dirt.tons + grass.tons +
  ...
  return {
    walkHrs, bobcatTrips, totalDemoTons,
    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <table className="w-full text-xs">
          ...
          <tbody className="divide-y divide-gray-50">
            {[
              {label:'Concrete',   sfK:'concSF',  dK:'concDepth',  dep:4, row:calc.conc,  fee:dumpConc,  rate: calc.rateConc,  rateName: 'Demo - Skid Steer Concrete/Dirt', rateNote:`${calc.rateConc} t/hr`},
              {label:'Dirt/Rock',  sfK:'dirtSF',  dK:'dirtDepth',  dep:6, row:calc.dirt,  fee:dumpDirt,  rate: calc.rateConc,  rateName: 'Demo - Skid Steer Concrete/Dirt', rateNote:`${calc.rateConc} t/hr`},
              {label:'Import Base',sfK:'baseSF',  dK:'baseDepth',  dep:4, row:calc.base,  fee:0,         rate: calc.rateBase,  rateName: 'Demo - Skid Steer Import Base',   rateNote:`${calc.rateBase} t/hr`},
              {label:'Grass/Sod',  sfK:'grassSF', dK:'grassDepth', dep:2, row:calc.grass, fee:dumpGreen, rate: calc.rateGrass, rateName: 'Demo - Skid Steer Grass',         rateNote:`${calc.rateGrass} t/hr · $${dumpGreen}/ton green waste`, extraIcon: (
      ...
      <div>
        ...
        <table className="w-full text-xs">
          ...
          <tbody className="divide-y divide-gray-50">
            {[
              {label:'Grade Cut',   sfK:'gradeCutSF',  dK:'gradeCutDepth',  dep:3, tons:calc.gradeCut.tons,  hrs:calc.gradeCut.hours,  note:`${calc.rateConc} t/hr`,  rate: calc.rateConc,  rateName: 'Demo - Skid Steer Concrete/Dirt'},
              {label:'Grade Fill',  sfK:'gradeFillSF', dK:'gradeFillDepth', dep:3, tons:calc.gradeFill.tons, hrs:calc.gradeFill.hours, note:`${calc.rateBase} t/hr`,  rate: calc.rateBase,  rateName: 'Demo - Skid Steer Import Base'},
              ...
              {label:'SS Compact',  sfK:'ssCmpSF',     dK:'ssCmpDepth',     dep:3, tons:calc.ssCmpTons,      hrs:calc.ssCmpHrs,        note:`${calc.rateSSCmp} t/hr`, rate: calc.rateSSCmp, rateName: 'Demo - SS Compaction'},
