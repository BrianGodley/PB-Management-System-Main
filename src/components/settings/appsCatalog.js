...
export const MODULE_INFO = {
  ...
  '/portal/subs':        { name: 'Subcontractors',       blurb: 'Subcontractor directory, contracts, and change orders.' },
  '/portal/vendors':     { name: 'Vendors',              blurb: 'Vendor directory, quotes, and material catalogs/pricing.' },
