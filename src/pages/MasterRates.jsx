...
const LABOR_CATEGORY_OPTIONS = ['Artificial Turf', 'Concrete', 'Demo', 'General', 'Irrigation', 'Planting', 'Pool']
...
export default function MasterRates() {
  ...
  return (
    <div>
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900">Master Rates</h1>
        <p className="text-sm text-gray-500 mt-0.5">
          Manage your pricing references — used across all estimates.
        </p>
      </div>
