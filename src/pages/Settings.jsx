    ...
    <div className="max-w-xl mx-auto">
        ...
        <form onSubmit={handleSave} className="space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 mt-1">
              This rate is used across all crew types for GP calculations. At $
              {parseFloat(form.labor_rate_per_man_day || 0).toFixed(2)}/MD, that's $
              {(parseFloat(form.labor_rate_per_man_day || 0) / 8).toFixed(2)}/hr.
            </p>
          </div>
      ...
      <div className="card mb-6">
        ...
        <p className="text-xs text-gray-400 mb-4">
          To add or remove team members, use the Supabase dashboard under Authentication → Users.
        </p>
      ...
      <div className="card bg-green-50 border-green-200">
        ...
        <div className="text-sm text-green-800 space-y-1.5">
          ...
          <p className="text-xs text-green-700">
            1 Man Day = 8 hours. A module with 3 man days at $
            {parseFloat(form.labor_rate_per_man_day || 400).toFixed(0)}/MD = $
            {(3 * parseFloat(form.labor_rate_per_man_day || 400)).toLocaleString()} labor cost.
          </p>
        </div>
      </div>
      </>
