...
<body>
  ...
  return (
    ...
    <div className="h-[calc(100dvh-2.75rem)] lg:h-[calc(100vh-2.75rem)] -mt-4 -mb-4 -mr-4 lg:-mt-6 lg:-mb-6 lg:-mr-6 flex flex-col overflow-hidden">
      ...
      <div className="flex items-center gap-2 flex-wrap px-3 sm:px-6 py-1.5 bg-white border border-gray-200 rounded-xl flex-shrink-0 ml-0 mr-2 sm:mr-3 mt-4 sm:mt-6 mb-3">
