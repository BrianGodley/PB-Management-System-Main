...
-- ── CMU structural labor productivity rates ───────────────────────────────────
...
INSERT INTO material_rates (name, unit, unit_cost, category) VALUES
  ('Wall Dig Footing Labor Rate',  'CF/hr',     4.0,  'Walls'),
  ('Wall Set Rebar Labor Rate',    'LF/hr',     35.0, 'Walls'),
  ('Wall Set Block Labor Rate',    'blocks/hr', 10.4, 'Walls'),
  ('Wall Hand Grout Labor Rate',   'CF/hr',     5.5,  'Walls'),
  ('Wall Pump Grout Labor Rate',   'CF/hr',     81.0, 'Walls'),
  ('Wall Setup Clean Labor Rate',  'LF/hr',     30.0, 'Walls')
ON CONFLICT DO NOTHING;
...
INSERT INTO material_rates (name, unit, unit_cost, category) VALUES
  ('Sand Stucco - Wall Labor Rate',    'SF/day', 92.00,   'Walls'),
  ('Smooth Stucco - Wall Labor Rate',  'SF/day', 65.00,   'Walls'),
  ('Ledgerstone - Wall Labor Rate',    'SF/day', 24.00,   'Walls'),
  ('Stacked Stone - Wall Labor Rate',  'SF/day', 24.00,   'Walls'),
  ('Tile - Wall Labor Rate',           'hrs/SF', 0.2867,  'Walls'),
  ('Real Flagstone - Wall Labor Rate', 'hrs/SF', 0.4487,  'Walls'),
  ('Real Stone - Wall Labor Rate',     'hrs/SF', 0.8954,  'Walls')
ON CONFLICT DO NOTHING;
